...
# @Last Modified time: 2016-09-07 01:48:17
...
class Loader(object):
        ...
        with open(path, 'w') as csvfile:
            ...
            for data in dataset:
                try:
                    ...
                    data = refined_data
                    # data = data.load_ext_features(content)
    ...
    @staticmethod
    def load_spark_data(filepath=None, \
                    output_filepath=None,   \
                    default_label=-1):
...
if __name__ == '__main__':
    ...
    Loader.load_spark_data(
        filepath='/Volumes/Expansion/2016_memex/job_ads.jl', 
        output_filepath=os.path.join(os.path.dirname(__file__), 'res', 'job_ads.csv'),
        default_label=4)
